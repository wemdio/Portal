...
-- USERNAME_NOT_OCCUPIED на ЖИВЫЕ ники, когда аккаунт урезан/frozen, а gramJS
-- маскирует этот RPC-код в строку «No user has X as username». Старый код ставил
-- status=skipped навсегда. Фикс логики — коммиты 739cfaeef, 3d5217daf,
-- ce79010a9 (финальный: ловит gramJS-маску) в origin/Sergey.
--
-- ВЫПОЛНЕНО 26.08.2026: вернул 441 контакт (за ночь добавились новые skip,
-- поэтому больше исходных 416), аккаунт 254360278 запаркован на 24ч.
--
-- Кампании и объёмы на момент запуска:
--   TG_VBI               273   (аккаунт 254360278, Василий — доказанная заморозка)
--   Polza_Старые аккаунты 81
--   ATOL-1                63
--   TG_Roistat            24
--   ИТОГО                441
--
...
--
-- ЗАПУСК: кириллица обязательна в UTF-8. Через PowerShell НЕ гонять файл пайпом
-- (Get-Content | ssh) — кодировка ломается и WHERE по русскому skip_reason не
-- находит ни одной строки. Запускать либо psql -f на сервере, либо передавать
-- SQL встроенным here-string (он уже в UTF-8).
--
