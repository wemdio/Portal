...
> Инфраструктурная пометка: документ зафиксирован до DB cutover. С 22.07.2026
> production-БД находится на `139.60.162.12`; упоминания `144.31.54.166` ниже
> описывают инфраструктуру на момент подготовки дизайна.
