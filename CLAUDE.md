...
Отдельно для агентов: **не добавляй тесты «за компанию» с правкой**. Тест
пишется на найденную ошибку или на новую ветку логики. Правка формулировки,
переименование, перенос кода тестов не требуют.
