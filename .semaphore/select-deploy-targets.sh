...
ALL_WORKER_SERVICES="worker-hh worker-eng-hiring worker-search worker-enrich worker-enrich-2 worker-enrich-3 worker-enrich-4 worker-enrich-5 worker-enrich-6 worker-enrich-7 worker-enrich-8 worker-enrich-9 worker-enrich-coordinator worker-yandexmaps worker-googleparsers worker-emailvalidation worker-inn-enrich worker-tg-outreach worker-aicaller worker-sales-copilot worker-sales-ai-analysis worker-leads-report worker-leads-report-bot worker-byo-send worker-byo-replies worker-sales-chat-logger worker-sales-chat-archive worker-tg-parser worker-tg-transcribe worker-instantly-leads worker-outreach worker-li-outreach worker-baseconstructor worker-baseconstructor-2 worker-baseconstructor-3 worker-baseconstructor-4 worker-baseconstructor-5 worker-baseconstructor-6 worker-client-report-exports worker-bob-scorer worker-manual-scoring worker-autopipeline worker-autorenew worker-hypothesis-engine worker-vertical-engine-v2"
