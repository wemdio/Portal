...
export const TOOLS_CONFIG: Record<ToolId, ToolConfig> = {
  ...
  'hypothesis-engine': {
    ...
    title: 'Движок вертикалей v1',
    title_en: 'Hypothesis Engine v1',
  ...
  'vertical-engine-v2': {
    ...
    description: 'База на гипотезу, сезонность, человеческие названия вертикалей и сегментно-осознанное превью.',
    description_en: 'Base-per-hypothesis, seasonality, human-readable vertical names, and segment-aware preview.',
  ...
  sender: {
    ...
    title: 'Рассылка',
    title_en: 'Sender',
    description: 'Своя отправка писем: подключение ящиков провайдера файлом, цепочки писем, ответы и стоп-лист. Без Instantly.',
    description_en: 'Our own email sending: connect provider mailboxes from a file, run follow-up chains, read replies, keep a suppression list.',
    href: '/tools/sender',
    badge: 'В разработке',
    badge_en: 'In development',
    badgeVariant: 'amber',
  ...
  'polza-ru-outreach': {
    id: 'polza-ru-outreach',
    title: 'Наш автоаутрич',
    title_en: 'Russian outreach (auto)',
    description:
      'Русский аутрич Polza по сигналам: найм SDR, автоматизация аутрича, выставки/контракты/новости → компания и почта → готовая цепочка писем.',
    description_en:
      'Russian signal-based outreach: SDR hiring, automated outreach, trade shows/contracts/news → company and mailbox → ready email sequence.',
    href: '/tools/polza-ru-outreach',
    accentColor: 'emerald',
    badge: 'В разработке',
    badge_en: 'In development',
    badgeVariant: 'amber',
