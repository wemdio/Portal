...
// и инструментами портала (парсеры HH.ru, Яндекс.Карты, поиск, Конструктор баз).
...
export const DEMO_BRIEF_HYPOTHESES_RESPONSE = {
  lead_source_hypotheses:
    '### Гипотеза 1: HH.ru — розничные сети, которые нанимают складской персонал\n' +
    '- Источник: парсер HH.ru\n' +
    ...
    '### Гипотеза 6: HH.ru — производственные компании с логистикой\n' +
    '- Источник: парсер HH.ru\n' +
