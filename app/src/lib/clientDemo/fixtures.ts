...
const demoBriefFields = normalizeBriefFields({
  ...
  company_description:
    ...
    'в складских процессах без долгого внедрения.',
  product_description:
    'Облачная система управления складом: приёмка, размещение, отбор, ' +
    'инвентаризация, интеграции с 1С, WB и Ozon. Внедрение за 2–3 недели, ' +
    'без покупки серверов.',
  target_audience:
    'Розничные сети с 3+ складами, 3PL и фулфилмент-операторы, ' +
    'производственные компании, крупные продавцы на маркетплейсах.',
  advantages:
    'Внедрение за 2–3 недели\nБез своих серверов — облако\n' +
    'Готовые интеграции 1С / WB / Ozon\nПоддержка 24/7',
  usp: 'WMS, которую запускают за 3 недели, а не за полгода.',
  avg_check: 'от 90 000 ₽/мес',
  price_tier: 'business',
