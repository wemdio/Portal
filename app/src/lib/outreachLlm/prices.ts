 ...
 * deepseek сверена с продовым журналом. Копия, а не импорт: таблица движка
 * меняется под его модели и его решения, и такая правка не должна молча
 * менять учёт денег аутричей.
 */
