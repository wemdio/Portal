...
2. Если есть конкретный сигнал (юбилей, вакансия ивент-менеджера) — строй hook вокруг него. Юбилей всегда в ТЕКУЩЕМ году — пиши «в этом году», никогда не указывай конкретный будущий год.
...
function buildUserPrompt(lead: HookInput): string {
  ...
  const lines = [
    ...
    lead.anniversary_year ? 'Юбилей (круглая дата) — В ЭТОМ ГОДУ' : null,
