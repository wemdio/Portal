...
export const ALL_ROLES: UserRole[] = ['technician', 'manager', 'director', 'admin', 'sales', 'marketer'];

const ROLES_CAN_CREATE_PROJECTS: UserRole[] = ['admin', 'manager', 'technician', 'director'];
const ROLES_CAN_EDIT_PROJECTS: UserRole[] = ['admin', 'manager', 'technician', 'director', 'sales', 'marketer'];
