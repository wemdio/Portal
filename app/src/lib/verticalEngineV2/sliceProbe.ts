...
export function sliceProbeSample(): number { return envNum('VE_SLICE_PROBE_SAMPLE', 30); }
 ...
 * Включается осознанно: VE_SLICE_PROBE_REPAIR_BELOW / _REJECT_BELOW.
 */
...
export function sliceProbeRepairBelow(): number { return envNum('VE_SLICE_PROBE_REPAIR_BELOW', 0); }
export function sliceProbeRejectBelow(): number { return envNum('VE_SLICE_PROBE_REJECT_BELOW', 0); }
