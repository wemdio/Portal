...
16. BROAD HYPOTHESIS (the candidate has "broad": true) — a whole sector taken on purpose: its base is refilled with new companies every day. Do not punish breadth: do not drop it or cut potential_pct for being general, do not merge it with narrow segments. Prove that the sector exists, can be reached and pays; merge only with another broad hypothesis from the list.
