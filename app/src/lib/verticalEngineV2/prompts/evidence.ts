...
21. ШИРОКАЯ ГИПОТЕЗА (у кандидата "broad": true) — сектор целиком, взятый намеренно: по ней база пополняется новыми компаниями каждый день. Широту не наказывай: не отбрасывай её и не режь potential_pct за общность, не сливай с узкими сегментами. Доказывай, что сектор существует, до него можно достучаться и он платит; merge — только с другой широкой гипотезой из списка.
