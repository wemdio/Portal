...
- НЕ СТАВЬ revenueFrom/revenueTo и employeesFrom/employeesTo. Размер компании — это ранжирование, а не отбор: релевантность и так отсеет мелочь, а порог режет рынок до дна. Замер: по нефтехимии «ОКВЭД 20.1 + выручка от 100 млн + штат от 50» дал 199 компаний вместо 2 863 доступных, и база встала на 13 контактах вместо 500. Отдельно: штат в реестре заполнен не у всех, и компания без этого поля отсекается порогом, даже если она крупная.
