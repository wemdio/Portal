...
- Для максимального покрытия не ставь hasEmail=true: почты будут собираться с сайта каждой компании, исходные адреса реестра используются как запасной вариант. includeIp=false по умолчанию для B2B.
