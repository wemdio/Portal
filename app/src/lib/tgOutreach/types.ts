 ...
 *
 * Это не собеседник. Чат с ним приходит непрочитанным при каждом логине
 * аккаунта (код подтверждения), поэтому без явного скипа воркер таскал его в
 * список диалогов кампании как обычного человека: там копились строки «ID
 * 777000» с кодами доступа — оператор видит в разметке мусор, а воркер звал
 * на него GPT. Скипаем и в цикле воркера, и в списке диалогов.
 */
