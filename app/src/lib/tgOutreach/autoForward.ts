 ...
 *
 * Кнопки «Передать лида/партнёра» намеренно остаются рабочими: карточка уходит
 * и автоматом, но передать того же человека в другой чат (например, партнёрам)
 * или досылать переписку повторно иногда нужно. Решение принимает оператор, а
 * не интерфейс, — поэтому он должен знать, что контакт уже у адресата.
 *
