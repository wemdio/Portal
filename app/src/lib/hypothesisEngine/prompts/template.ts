...
- Письмо 1 специфицируй по обязательному скелету: мостик релевантности (наблюдаемый факт о сегменте получателя, не голая категоризация «Вы продаёте в X») → «Мы — {услуга простыми словами}» → «{результат для получателя}» → один мягкий CTA. Письмо 1 обязано проходить тест 5 секунд: незнакомец мгновенно понимает, кто пишет, что предлагают и чем это выгодно ему. Описания процесса отправителя («собираем сигналы», «пишем под контекст») в письме 1 запрещай — процессу место в письмах 2+.
...
- Оффер простыми словами: услуга клиента называется одной понятной постороннему фразой из fixed_block/исходной цепочки — размытые ярлыки («внешняя команда», «партнёр по росту») запрещены. Выгода — это результат для получателя в его единицах (встречи/лиды/сделки с названными целевыми ролями за период), а НЕ процесс отправителя («пишем письма», «занимаемся аутричем»).
- Письмо 1 — обязательный скелет: (1) мостик релевантности — наблюдаемый факт о сегменте получателя, не голая категоризация «Вы продаёте в X»; (2) «Мы — {услуга простыми словами}»; (3) «{результат для получателя}»; (4) один мягкий CTA. Тест 5 секунд: незнакомец мгновенно отвечает — кто это, что продают, чем это выгодно мне. Описания процесса отправителя («собираем сигналы», «пишем под контекст») в письме 1 запрещены — процессу место в письмах 2+.
