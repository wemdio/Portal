...
- ОКВЭД: НИКОГДА не выдумывай коды, в которых не уверен. Только класс XX или группа XX.X (например «62», «62.01»). Меньше точных кодов лучше, чем много приблизительных. Самопроверка: назови официальное название каждого кода; не уверен — не включай.
