...
- CTA-вопрос «созвон на 15 минут?» — минус 37% reply. CTA — мягкий и человеческий: предложить прислать детали/пример, уточнить интерес. В каждом письме — ровно один CTA. Просьба направить к нужному человеку («к кому лучше обратиться?») допустима ТОЛЬКО в последнем шаге цепочки.
