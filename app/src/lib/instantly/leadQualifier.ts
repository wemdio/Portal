...
КАТЕГОРИИ:
1. КВАЛИФИЦИРОВАННЫЙ ЛИД — клиент видел предложение И проявил интерес (уточняющие вопросы, запрос цен, предложение позвонить/встретиться, обсуждение условий). ИСКЛЮЧЕНИЕ: запрос цен/стоимости/КП/материалов — ЛИД и без увиденного предложения (правило ниже).
