...
type NonLeadKind = 'seller_pitch' | 'service_followup' | 'contact_routing';
...
- При non_lead_kind != null и отсутствии совпадения с положительным кастомным критерием ставь is_lead=false, needs_review=false. При сомнении в направлении или для иных ответов non_lead_kind=null. Не выдумывай направление из подписи или цитаты.
...
ФОРМАТ ОТВЕТА (только валидный JSON, без markdown):
{
  ...
  "non_lead_kind": "seller_pitch"/"service_followup"/"contact_routing"/null,
  "is_lead": true/false,
