 ...
 * (итог не длиннее легенды +2 коротких предложения). Температура 0.4.
...
- Если в легенде УЖЕ есть благодарность или обещание вернуться с информацией, уточни эту существующую фразу под запрос лида, а НЕ добавляй вторую с тем же смыслом. Например: «Вскоре вернусь с информацией» → «Вскоре вернусь с информацией по вашему вопросу».
- Реакция на запрос необязательна. Если её нельзя встроить без повторов и новых обещаний, оставь исходную фразу. Не добавляй «соберу и пришлю», звонок или другое действие, которого не было в легенде.
...
- Сохраняй основной текст легенды; разрешено заменить существующую фразу её уточнённым вариантом, но не оставлять оба варианта. Не повторяй благодарность, обещание вернуться или объяснение о копии разными словами. Итог — не длиннее легенды больше чем на 2 коротких предложения.
...
- Сохраняй абзацы и переносы строк. Без темы письма и без новой подписи. Если подпись уже есть в легенде, сохрани её дословно, включая контакты; если её нет, не придумывай её.
