...
const DEFAULT_LEAD_RULE =
  'Лид — человек, который проявил положительный интерес к вашему предложению, запросил цену или КП, предложил следующий шаг либо выполнил CTA. Ответ «интересно» на конкретный оффер и готовность к сотрудничеству тоже считаются лидом.';
const DEFAULT_NOT_LEAD_RULE =
  'Не лид: автоответы, отписки, отказы и простое перенаправление в приёмную или другому сотруднику без собственного интереса.';
