  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="p-5">
          <textarea
            className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none text-sm font-mono min-h-[150px] p-3"
        ...
        <div className="p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="US"
            />
            <p className="text-xs text-gray-500">ISO 3166 (US, GB, DE, ...).</p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="en"
            />
            <p className="text-xs text-gray-500">ISO 639-1 (en, ru, ...).</p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-gray-500">Фильтр свежести новостей.</p>
          </div>
