        ...
        <div className="flex-shrink-0">
          {paymentUrl ? (
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-lg bg-white/20 hover:bg-white/30 px-4 py-2 text-xs font-semibold text-white transition"
            >
            ...
            <button
              onClick={handlePay}
              disabled={paying}
              className="inline-flex items-center gap-1.5 rounded-lg bg-white/20 hover:bg-white/30 px-4 py-2 text-xs font-semibold text-white transition disabled:opacity-60"
            >
          ...
          {payError && (
            <p className="text-[11px] text-white/70 mt-1 text-right">{payError}</p>
          )}
        </div>
      )}
    </div>
