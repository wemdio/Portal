...
export type FiltersState = {
  ...
  cohort: boolean;
  /**
   * Выбранный период целиком (YYYY-MM-DD), когда таблицы сужены кликом по
   * столбцу графика до одного дня: режим «без когорты» судит о «заведена в
   * периоде» по нему, а не по дню. Ставит только FirstSalesView для таблиц;
   * панель фильтров его не показывает и не хранит.
   */
  cohortFrom?: string;
  cohortTo?: string;
};
