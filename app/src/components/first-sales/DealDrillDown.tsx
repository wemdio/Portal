    ...
    <tr>
      <td colSpan={colSpan} className="bg-zinc-50/60 px-3 py-3">
        ...
        <p className="mt-1.5 text-[11px] text-zinc-400">
          Показаны сделки, созданные в выбранном периоде. Договоры и оплаты считаются по своим
          датам, поэтому договор или платёж по сделке, пришедшей раньше периода, попадёт в цифры
