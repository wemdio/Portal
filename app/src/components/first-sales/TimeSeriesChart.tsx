  ...
  return (
    <div ref={rootRef} className="glass-tile p-3">
      ...
      <p className="mt-2 text-[11px] text-zinc-400">
        «Квал (из пришедших)» — когорта: из лидов, пришедших в эту корзину, сколько дошли до квалификации в пределах
        выбранного периода (квал после его конца не засчитывается). «Встречи» и «Договоры» — по дате самого события, а не даты прихода лида.
