...
function CampaignDetailPageContent() {
  ...
  const openRate = reachedCount > 0 ? ((openCount / reachedCount) * 100).toFixed(1) : '0';
                    ...
                    <div className="px-3 sm:px-5 py-3 sm:py-4 space-y-4">
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          className="ds-input w-full text-sm resize-y min-h-[36rem] leading-relaxed"
                        />
                      </div>
                        ...
                        return (
                          <div key={variantIdx} className="space-y-2 pt-3 border-t" style={{ borderColor: 'var(--cp-divider)' }}>
                            ...
                            <textarea
                              ...
                              rows={18}
                              placeholder="Текст письма"
                              className="ds-input w-full text-sm resize-y min-h-[26rem] leading-relaxed"
                            />
                          </div>
                        );
                      })}
