    ...
    <div className="max-w-3xl mx-auto py-10 px-4">
      ...
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Постоянно прогоняет компании из «базы баз» (~600 тыс. с оборотом ≥ 40 млн)
          через Mailganer-скоринг. Найденные активные домены попадают в общий кэш
          и используются ежедневным прогоном auto-pipeline вместо случайной выборки.
        </p>
      </header>
