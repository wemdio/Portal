...
import { Users, FileText, Database, Activity, MessageCircle, Bot, Settings, Globe } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <Link href="/admin/domains" className={cardClass}>
          <div className="flex h-full flex-col">
            <div className="mb-4 flex items-start justify-between">
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Мониторинг доменов</h2>
                <p className="text-sm text-gray-500">
        ...
        <Link href="/admin/env" className={cardClass}>
          <div className="flex h-full flex-col">
            <div className="mb-4 flex items-start justify-between">
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Переменные окружения</h2>
                <p className="text-sm text-gray-500">
