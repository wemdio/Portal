 ...
 * объяснять в переписке. Этап каждой сделки берётся на последний день
 * периода, а не на сегодня (см. lib/renewals/funnel.ts): августовская воронка
 * не должна меняться от того, что сделку продлили в сентябре.
 */
