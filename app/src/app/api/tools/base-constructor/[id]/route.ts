 ...
 *
 * На практике эти две минуты почти всегда перекрывает проверка аренды ниже:
 * пока у задачи живой исполнитель, роут её не трогает вовсе. Значит, задача,
 * чей воркер умер прямо перед финальной записью, дождётся не двух минут, а
 * истечения аренды (до 5 минут). Размен сознательный: лишние минуты ожидания
 * дешевле, чем завершённая из-под живого воркера задача с недособранным
 * результатом.
 */
