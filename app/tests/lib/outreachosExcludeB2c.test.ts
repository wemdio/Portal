...
describe('isPersonName', () => {
  ...
  it.each([
    ...
    'Строительный Двор Петрович', // «-ович», но среднее слово — не имя → бренд
...
describe('matchOutreachOsB2cRule — позитивные (шум из классификации)', () => {
  it.each<[string, string, string]>([
    ...
    ['Футбольный клуб Зенит', '', 'name:футбольный клуб'],
    ...
    ['Кофейня Даблби', '', 'name:общепит'],
    ['Пекарня Хлебница', '', 'name:общепит'],
    ['Агентство недвижимости М16', 'http://m16-elite.ru', 'name:недвижимость'],
    ['Салон красоты Багира', '', 'name:красота/фитнес'],
    ['Турагентство Роза Ветров туроператор', '', 'name:туризм'],
    ['Ломбард Успех', '', 'name:ломбард'],
    // Off-ICP B2B (владелец 07.07): физохрана / ЖКХ / госпредприятия
    ['ЧОП Логос Титул', 'https://www.logos-titul.ru', 'icp:чоп'],
    ['Охранное агентство Кобра', 'http://cobra18.ru', 'icp:чоп'],
    ['Частная охранная организация', 'http://ss01.ru', 'icp:чоп'],
    ['ЧОО Сокол', '', 'icp:чоп'],
    ['Управляющая компания ЖКХ Восток', '', 'icp:жкх'],
    ['МУП Водоканал', '', 'icp:жкх'],
    ['Жилищно-коммунальное хозяйство №5', '', 'icp:жкх'],
    ['ТСЖ Рассвет', '', 'icp:жкх'],
    ['ФГУП НПП Гамма', 'http://www.nppgamma.ru', 'icp:госпредприятие'],
    ['ГУП Мосгортранс', '', 'icp:госпредприятие'],
...
describe('matchOutreachOsB2cRule — негативные (B2B не задеваем)', () => {
  it.each<[string, string]>([
    ...
    // Найдены адверсариальным ревью — правила ужесточены:
    ['ФК ПУЛЬС', 'https://puls.ru'], // ФК = фармкомпания, не футбольный клуб
    ['Банк ФК Открытие', 'https://open.ru'], // ФК = финансовая корпорация
    ['ФК Зенит', 'http://www.fc-zenit.ru'], // голое «фк» больше не режем — цена за ФК ПУЛЬС
    ['Hotellab', 'https://hotellab.io'], // hotel-tech SaaS для отелей = B2B
    ['The Hotels Network', 'https://thehotelsnetwork.com'], // B2B-маркетинг для отелей
    ['Профэшн', 'https://profashion-magazine.ru'], // magazine ≠ magazin
    ['Школьная карта', 'https://shkolnaya-karta.ru'], // финтех ДЛЯ школ = B2B
    ['Кофейное оборудование Трейд', ''], // поставщик В вертикаль
    ['Ресторан-Сервис Плюс', ''], // поставщик оборудования для ресторанов
    ['Коммерческая недвижимость Сити', ''], // CRE = B2B
    // Off-ICP правила НЕ должны задевать целевой кибербез/IT (владелец 07.07):
    ['Security Vision', 'https://www.securityvision.ru/'], // кибербез
    ['Стратегия информационной безопасности', 'https://strateg-ib.ru'], // ИБ-консалтинг
    ['Система Безопасных Коммуникаций', 'https://communigatepro.ru/'], // enterprise-софт
    ['Группа Компаний Бизнес Процесс', 'https://spboutsourcing.ru/'], // «группа» ≠ ГУП
    ['Охранная сигнализация Гранд', ''], // B2B-оборудование, не ЧОП-агентство
    // По ground truth 05.07 — B2B, правила удалены (шум добирает LLM-рубеж):
    ['Издательский Дом Питер', 'http://www.piter.com'], // опт книготорговым сетям
    ['Издательство МОЗАИКА-СИНТЕЗ', 'https://mozaikabooks.ru/'], // опт
    ['Московская коллегия адвокатов', 'https://tp-law.com/'], // корп-юрфирма
