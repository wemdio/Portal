 ...
 * краха/OOM/SIGKILL ≈ аренда (3 мин) + один опрос (30 с — простаивающий цикл
 * ждёт Math.max(pollIntervalMs, 30_000), см. effectiveFallback в _shared.ts).
...
async function main(): Promise<void> {
  ...
  >({
     ...
     *  - прогон, у которого осталось меньше 25 необработанных строк: сброс
     *    прогресса идёт раз в PROGRESS_FLUSH_EVERY = 25 строк.
     ...
     *    ≤ LEASE_SECONDS + один опрос ≈ 3,5 минуты. Это главный сценарий, и
